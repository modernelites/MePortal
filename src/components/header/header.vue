      ...
      <div class="inner_header_con" v-bind:class="{ search_active: showSearch }">
        ...
        <div class="header_search_box">
          <form method="" action="">
            ...
            <input type="text" name="header_search" class="header_search_input" autocomplete="off" @focus="show_search_input" @blur="hide_search_input" ref="searchValue">
      ...
      <div v-show="searchWrapShow" class="search_wrap">
        <transition name="fade">
          <div class="search_head" :class="{bgActive:searchListShow}">
            ...
            <input type="text" name="text" class="search_input" v-on:focus="navWrapperShow=false,searchListShow=true" v-on:blur="searchListShow=false" v-model="search.value" ref="searchValue">
